...
public class TestBase implements SauceOnDemandSessionIdProvider {
    ...
    public static LinkedList browsersStrings() {
        ...
        browsers.add(new String[]{"Android", "Samsung Galaxy S6", "6.0", "1.6.5", "portrait"});
      browsers.add(new String[]{"Android", "Google Pixel", "7", "1.6.5", "portrait"});
...
//        browsers.add(new String[]{"Android", "Samsung Galaxy S4 Emulator", "4.4", "1.5.3", "portrait"});
    ...
    public static void setupClass() {
        ...
        //seleniumURI = "@ondemand.saucelabs.com:443";
    		seleniumURI = "http://us1.appium.testobject.com/wd/hub";
